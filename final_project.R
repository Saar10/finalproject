...
# Export
write.csv(correlated_buy_gain, file = "correlated_buy_gain.csv")
write.csv(correlated_buy_loss, file = "correlated_buy_loss.csv")
write.csv(correlated_sell_gain, file = "correlated_sell_gain.csv")
write.csv(correlated_sell_loss, file = "correlated_sell_loss.csv")
write.csv(uncorrelated_buy_gain, file = "uncorrelated_buy_gain.csv")
write.csv(uncorrelated_buy_loss, file = "uncorrelated_buy_loss.csv")
write.csv(uncorrelated_sell_gain, file = "uncorrelated_sell_gain.csv")
write.csv(uncorrelated_sell_loss, file = "uncorrelated_sell_loss.csv")
